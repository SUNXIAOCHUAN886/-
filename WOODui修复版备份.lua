...
local win1 = library:CreateTab("主要");

win1:NewButton("点击出现群号", function()
...
win1:NewButton("菜市场", function()--演示
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(475.7712707519531, 16.049907684326172, -199.3191375732422)
    print("btn3");
end)

win1:NewButton("网吧", function()--演示
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(375.0467529296875, 16.0000057220459, -511.1214294433594)
    print("btn3");
end)

win1:NewButton("小区", function()--演示
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(189.17945861816406, 16.10001564025879, -1059.6727294921875)
    print("btn3");
end)

win1:NewButton("矿洞内部", function()--演示
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(461.5960998535156, -151.6399383544922, -1275.9495849609375)
    print("btn3");
end)

win1:NewButton("矿洞房子处", function()--演示
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(295.4396057128906, 16.10000991821289, -1258.064208984375)
    print("btn3");
end)

win1:NewButton("五金店", function()--演示
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(559.6861572265625, 16.0101375579834, -948.3832397460938)
    print("btn3");
end)

win1:NewButton("街道", function()--演示
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(344.82318115234375, 16.00000762939453, -763.9656372070312)
    print("btn3");
end)
...
local win1 = library:CreateTab("无");
win1:NewToggle("无", "i", true, function(bool)
    print(bool)
        flags.light = val
...
win1:NewSlider("无", "滑块id", _default, min, max, showFloat, function(value)
    print(("现在是%d"):format(value));
end)


win1:NewToggle("无功能", "id随便", false, function(bool)
    print(bool)
end)
...
win1:NewDropdown("暂无", "这个有用", this_table, function(item)
	print(item);
end)

win1:NewButton("添加元素", function()
    library.flags["这个有用"]:AddOption("无");
end)

win1:NewButton("删除元素", function()
    library.flags["这个有用"]:RemoveOption("无");
end)

win1:NewBox("暂时无功能", function(text)
    print(text);
end)
